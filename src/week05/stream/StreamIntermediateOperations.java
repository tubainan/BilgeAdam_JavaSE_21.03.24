...
public class StreamIntermediateOperations {
    public static void main(String[] args) {
        ...
        Stream.of(1,2,3,4,5)
                ...
                .map(i ->i*i)
                .peek(i -> System.out.printf("%d ", 1))
                .collect(Collectors.toList());

        //filter()  -> Verilen koşula uymayan elemanların kaldırılması için kullanılır
        ...
        //distinc() -> yinelenen(duplicate) değerlerin(value)
        //kaldırıldığı(remove) bir stream döndürür.

        Stream.of("Java","Java8","JAva")
                .distinct()
                .forEach(System.out::println);

        //skip() & limit()
        //skip(n) discard işlemidir. n negatif olamaz
        ...
        Stream<String> s =Stream.of("Alperem","Ali","Ayşe");
